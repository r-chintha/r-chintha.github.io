var store = [{
        ...
        "excerpt":"Pakcage Rcpp allows you to use C++ or C code in an R environment. It’s a great tool to enhance speed of your program, at the price of longer programming and harder debugging. But when it finally works out, it’s totally worth it. On stackoverflow (as of date 2016/9/22), number...","categories": [],
        "tags": ["R"],
        "url": "http://localhost:4000/Rcpp_basic/",
        "teaser":null},{
        "title": "some BASH topics",
        "excerpt":"The more I use bash the more I find it interesting. Basically every time I encounter a useful bash commands or when I learn something new about a command, I write them down for future reference. Quick links: Regular Expression File Globbing Bash Arrays find vim grep sed head,tail OthersOnline...","categories": [],
        "tags": ["bash"],
        ...
        "excerpt":"A great advantage of R over other statistical software (such as SAS, STATA) is that it is open source, and allows millions of programmers to contribute to the community. Tons of R packages are being created everyday. Mastering a couple of useful packages can help a great deal in daily...","categories": [],
        "tags": ["R"],
        "url": "http://localhost:4000/R_advanced/",
        "teaser":null},{
        "title": "Build your own website (with Jekyll and Minimal-mistakes theme)",
        "excerpt":"This whole website is built using Jekyll and theme minimal-mistakes. I had no experience of HTML or CSS language, but still managed to get the website to work. That’s just how easy it is to work with Jekyll. I wouldn’t go through every step of the process in great detail...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/personal_website/",
        "teaser":null},{
        "title": "Python quick reference",
        "excerpt":"Resources for beginners without much programming background: Learn python the hard way a more systematic tutorial: python: tutorialspoint from R to Python: python for RContents Special Characters Variables and Operators Functions Input/Output Control Flow Data Structures &amp; Classes Modules Python for data analysis Selected topics Other Special characters #: add...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/python/",
        "teaser":null},{
        "title": "Git for version control",
        "excerpt":"Git is a great version control tool. It allows you to keep a history of your code, sync your project online and collaborate with others. resource Online git simulator and tutorial: git branching git tutorial: git tutorial A visual git referenceBASIC configurations git config --global user.name \"your name\" git config...","categories": [],
        "tags": ["git"],
        "url": "http://localhost:4000/git/",
        "teaser":null},{
        "title": "Test Notebook",
        "excerpt":"# Normal Distributionimport numpy as npimport matplotlib.pyplot as plt%matplotlib inlineplt.hist(np.random.normal(size=100000), bins=30)plt.show() ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/test_notebook1/",
        "teaser":null},{
        "title": "Texas Unemployment",
        "excerpt":"This is sample post on TX unemp. import bokeh as bokehfrom bokeh.plotting import figure, output_file, output_notebook, show#from bokeh.io import show, output_filefrom bokeh.models import LogColorMapperfrom bokeh.palettes import Viridis6 as palettefrom bokeh.models import HoverTool#bokeh.sampledata.download()Creating C:\\Users\\rkvk\\.bokeh directoryCreating C:\\Users\\rkvk\\.bokeh\\data directoryUsing data directory: C:\\Users\\rkvk\\.bokeh\\dataDownloading: CGM.csv (1589982 bytes) 1589982 [100.00%]Downloading: US_Counties.zip (3182088 bytes) 3182088 [100.00%]Unpacking: US_Counties.csvDownloading:...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/Texas_Unemployment/",
        "teaser":null}]
